...
public class FactoryAnnotatedClass {
    ...
    public FactoryAnnotatedClass(TypeElement classElement) throws IllegalArgumentException {
        ...
        System.out.println("==========11111====>  " + qualifiedSuperClassName);
        System.out.println("==========22222====>  " + simpleTypeName);
        System.out.println("==========33333====>  " + annotatedClassElement.getQualifiedName().toString()
        );
    }
